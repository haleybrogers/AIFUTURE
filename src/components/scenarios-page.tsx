...
const staticAssumptions: Assumption[] = [
  ...
  {
    id: "19", title: "Most of the internet will be AI-generated — and people will stop trusting it",
    description: "Right now, most content on the internet was made by humans. Within a few years, the majority will be AI-generated. This creates a massive trust problem — how do you know if a review is real? If an article was written by a person? If the ad you're seeing has any truth to it? People will start tuning out digital content the way they tune out spam. This pushes marketing toward real-world experiences, verified sources, and human-to-human connection.",
    category: "market", convictionScore: 80,
    evidence: [
      { id: "e27", content: "Social media platforms are already flooded with AI-generated content. Some estimates suggest over 50% of internet content will be AI-generated by 2027. Engagement on AI-generated posts is declining as people learn to spot it.", type: "for", sourceUrl: null },
      { id: "e28", content: "Google and Meta are both struggling with AI-generated spam in their ad networks. Brand safety is becoming a bigger concern, pushing brands toward verified, trusted channels.", type: "for", sourceUrl: null },
    ],
    serviceLinks: [],
  },
  {
    id: "20", title: "The best companies will be tiny",
    description: "If one person with AI can do what five people used to do, then a 10-person agency can deliver what a 50-person agency used to. Companies like 11 Labs run hundreds of people in just 2 organizational layers. The most profitable companies of the AI era won't be the biggest — they'll be the leanest. Small teams that move fast, make decisions quickly, and use AI to punch way above their weight class.",
    category: "org_structure", convictionScore: 85,
    evidence: [
      { id: "e29", content: "11 Labs operates with just 2 organizational layers despite having hundreds of employees. Each person manages about 15 people. (From Nima's strategy discussion)", type: "for", sourceUrl: null },
      { id: "e30", content: "Nima built HopKit — a product that would have taken 3-4 people 6 months — in about 6 weeks by himself using AI. At current rates of improvement, the same thing might take 2 days in a year.", type: "for", sourceUrl: null },
    ],
    serviceLinks: [],
  },
  {
    id: "21", title: "Your data is your most valuable asset — don't give it away",
    description: "Companies used to freely share their code and data with AI providers for training. Then they realized: they were making their competitors smarter for free. Now the smart companies are keeping their data private and training their own AI on it. For an agency like Pearmill, years of performance data across clients — what ad creative works, what targeting converts, what copy drives clicks — is an incredibly valuable dataset that no one else has. Protecting it and building AI on top of it could be the biggest competitive advantage.",
    category: "technology", convictionScore: 85,
    evidence: [
      { id: "e31", content: "Companies gave code to Anthropic for training, and Anthropic used it to build the best coding model. Those companies stopped sharing when they realized the power of their data. (From Nima's strategy discussion — Standard Oil analogy)", type: "for", sourceUrl: null },
      { id: "e32", content: "Flux's AI coding tool (Devin) was terrible at first but after months of learning their specific codebase, it outperforms generic AI tools. Data that's specific to your business makes AI exponentially more useful.", type: "for", sourceUrl: null },
    ],
    serviceLinks: [],
  },
  {
    id: "22", title: "Junior roles shrink, but the path to seniority speeds up",
    description: "Entry-level tasks like data entry, basic reporting, and first-draft writing are the easiest to automate. The traditional 'ladder' where you start with grunt work and slowly earn more responsibility is disappearing. But here's the flip side: junior people who embrace AI can leapfrog years of experience. They can learn technical skills in weeks instead of years. The new hiring question isn't 'how many years of experience do you have?' — it's 'how fast can you learn and how good is your judgment?'",
    category: "org_structure", convictionScore: 75,
    evidence: [
      { id: "e33", content: "Entry-level marketing positions are the easiest to automate: data entry, basic reporting, first-line customer support, junior programming. These are the jobs new graduates rely on. (AI Log 2026)", type: "for", sourceUrl: null },
      { id: "e34", content: "Haley built a production-quality website in 2 days with no prior coding experience. That would have taken a bootcamp grad weeks. The speed of skill acquisition has fundamentally changed.", type: "for", sourceUrl: null },
    ],
    serviceLinks: [],
  },
  {
    id: "23", title: "Trust becomes a product people will pay for",
    description: "As AI floods the world with content, fake reviews, and synthetic media, trust becomes scarce. People will pay a premium for brands, agencies, and information sources they actually trust. This is why personal brands matter more, why word-of-mouth referrals become more valuable, and why agencies with proven track records can charge more — because trust can't be generated by AI.",
    category: "market", convictionScore: 80,
    evidence: [
      { id: "e35", content: "Brand safety spending is increasing year over year as companies try to avoid their ads appearing next to AI-generated misinformation. Trust in digital advertising is declining while spending on verified, premium placements grows.", type: "for", sourceUrl: null },
      { id: "e36", content: "The companies winning right now have strong human brands — founders you can see, teams you can meet, case studies you can verify. AI can't fake a 10-year track record of client results.", type: "for", sourceUrl: null },
    ],
    serviceLinks: [],
  },
  {
    id: "24", title: "Building software is the new Excel — everyone will be able to do it",
    description: "Right now, building software requires specialized skills. Within 12 months, it'll be as common as using a spreadsheet. You'll tell AI what you want, and it builds it. Three people at Pearmill who were hired as marketers are now building real software products. This isn't a fluke — it's the new normal. The implication: you don't need to hire developers for most internal tools. Anyone on the team can build what they need.",
    category: "technology", convictionScore: 90,
    evidence: [
      { id: "e37", content: "Nima's analogy: 'Software building is the new Excel. Everyone in white-collar work will be able to build software within 12 months the way they can use spreadsheets today.' (From Pearmill strategy session)", type: "for", sourceUrl: null },
      { id: "e38", content: "Haley, Dino, and Justin at Pearmill are all building software products despite being hired for marketing, creative, and account management roles. This is already happening.", type: "for", sourceUrl: null },
    ],
    serviceLinks: [],
  },
  {
    id: "25", title: "Agencies need to become research labs, not just production shops",
    description: "Here's a wild stat: America's top 100 law firms made $69 billion in profit in 2025. Every single cent was paid out to partners as compensation — zero invested in research and development. Professional services firms have never been built to innovate. They're built to extract. But AI changes the equation: the firms that invest in R&D — in building their own tools, training their own AI, inventing new methods — will create compounding advantages that traditional firms can't match. Think SpaceX: when they moved from cost-plus pricing (paid by the hour) to fixed-price (paid for results), they invented reusable rockets. That's what happens when your incentives shift from billing time to creating value.",
    category: "org_structure", convictionScore: 80,
    evidence: [
      { id: "e39", content: "Top 100 US law firms made $69B in profit in 2025 — more than Google's entire R&D budget — but paid every cent out as partner compensation. Zero invested in innovation. (Ryan Daniels, NeoFirms essay)", type: "for", sourceUrl: null },
      { id: "e40", content: "SpaceX moved from cost-plus (paid per hour of work) to fixed-price (paid for results). This incentive shift forced them to innovate reusable rockets — something NASA never achieved in decades of cost-plus contracting.", type: "for", sourceUrl: null },
    ],
    serviceLinks: [],
  },
  {
    id: "26", title: "AI output is just input — the real skill is what you do with it",
    description: "Jack Dorsey made this point clearly: most people treat what AI produces as the finished product. They accept the first answer. But the best people treat AI output as raw input — a starting point they then shape with their own judgment, taste, and experience. It's the difference between accepting a first draft and editing it into something great. The companies and people who understand this will consistently outperform the ones who just press 'generate' and ship whatever comes out.",
    category: "org_structure", convictionScore: 90,
    evidence: [
      { id: "e41", content: "Jack Dorsey (founder of Twitter and Block): 'People are seeing what the intelligences do as output rather than better input to create better output. Having someone who's able to discern signal from noise — the taste thing is real.'", type: "for", sourceUrl: null },
      { id: "e42", content: "Dorsey spent 3 hours every morning for a year pushing AI tools: 'This is input to me. It's now up to me to make better output from all this new input.' He treated AI as research material, not as a finished product.", type: "for", sourceUrl: null },
    ],
    serviceLinks: [],
  },
  {
    id: "27", title: "Losing credibility is the cost of doing something new — and it's worth it",
    description: "Block (formerly Square) built Cash App with a team of 8 people. Everyone in the company hated it. The board didn't understand it. They barely mentioned it in their IPO filing. Jack Dorsey defended it for 2-3 years while losing credibility internally. Today, Cash App is over half of Block's business. The lesson: any company trying to reinvent itself will face internal resistance. The people doing the old thing well will push back because change threatens their position. But if the conviction is there, the short-term credibility loss is worth the long-term transformation.",
    category: "org_structure", convictionScore: 75,
    evidence: [
      { id: "e43", content: "Cash App had a team of 8 people that was universally hated inside Block for 2-3 years. It was mentioned fewer than 8 times in their S1 (IPO filing). Today it's over half the company's business. (Jack Dorsey, podcast interview)", type: "for", sourceUrl: null },
      { id: "e44", content: "When Octane built an AI tool that replaced 16 people's jobs, the people whose jobs were threatened pushed back hard. Adoption resistance is real and expected. (From Pearmill strategy session)", type: "for", sourceUrl: null },
    ],
    serviceLinks: [],
  },
  {
    id: "28", title: "Your company should be completely 'legible' — every action creates data",
    description: "Every Slack message, every email, every meeting recording, every document, every code commit — all of these are 'artifacts' of how your company works. Jack Dorsey's idea: put an AI intelligence layer on top of all these artifacts, and suddenly anyone in the company can 'have a conversation with the company' about how it's doing. Imagine if every board member could query your company's data in real time instead of waiting for a quarterly slide deck. Imagine if your newest employee had the same access to institutional knowledge as a 10-year veteran. That's what a 'legible' company looks like.",
    category: "technology", convictionScore: 70,
    evidence: [
      { id: "e45", content: "Jack Dorsey: 'If you imagine your company was entirely legible — every aspect of it — we're not far off from that from a data perspective. It's putting the intelligence on top of it and making it useful.'", type: "for", sourceUrl: null },
      { id: "e46", content: "Pearmill is already doing this by feeding institutional knowledge into Notion, where AI agents get smarter about the company's craft over time. (From Nima's strategy session)", type: "for", sourceUrl: null },
    ],
    serviceLinks: [],
  },
];
...
const assumptionOpportunities: Record<string, RevenueOpp[]> = {
  ...
  "Agencies need to become research labs": [
    {
      icon: Rocket,
      title: "Pearmill R&D Lab",
      oneLiner: "Invest a percentage of profit into building proprietary AI tools and methods",
      pricing: "Internal investment — creates long-term competitive moat",
      phase: "6 Months",
      detail: "Instead of paying out all profit like traditional agencies, invest in R&D. Build proprietary tools, develop new methodologies, create compounding advantages competitors can't copy.",
    },
  ],
  "AI output is just input": [
    {
      icon: Paintbrush,
      title: "Premium Creative Direction",
      oneLiner: "The anti-generate-and-ship agency — human taste applied to AI output",
      pricing: "$10,000 – $30,000/mo",
      phase: "Now",
      detail: "Position as the agency that treats AI output as raw material, not finished product. Every piece gets human judgment, taste, and iteration. That's the premium.",
    },
  ],
  "company should be completely legible": [
    {
      icon: BarChart3,
      title: "Company Intelligence Setup",
      oneLiner: "Help clients build their own 'legible company' — AI on top of all their internal data",
      pricing: "$15,000 – $50,000/project",
      phase: "1 Year",
      detail: "Jack Dorsey's vision: put AI intelligence on top of every artifact the company produces. Pearmill could help clients set this up for their marketing operations — every campaign, every result, every learning becomes queryable.",
    },
  ],
};
